  ...
  return Table(
    ...
    children: [
      TableRow(
        ...
        children: [
          _cell(AppStrings.id, isHeader: true),
          _cell(AppStrings.image, isHeader: true),
          _cell(AppStrings.firstName, isHeader: true),
          _cell(AppStrings.lastName, isHeader: true),
          _cell(AppStrings.email, isHeader: true),
          _cell(AppStrings.phone, isHeader: true),
        ],
      ),

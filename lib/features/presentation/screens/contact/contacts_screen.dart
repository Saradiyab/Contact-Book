...
import 'package:contact_app1/features/presentation/screens/contact/create_contact_screen.dart';
import 'package:contact_app1/features/presentation/screens/contact/pdf_export_screen.dart';
import 'package:contact_app1/features/presentation/screens/contact/send_email_screen.dart';
import 'package:contact_app1/features/presentation/widgets/contact%20widget/button_widget.dart';
import 'package:contact_app1/features/presentation/widgets/contact%20widget/contact_card.dart';
...
import 'package:contact_app1/features/presentation/widgets/search.dart';
          ...
          return PopupMenuButton<String>(
            ...
            itemBuilder: (context) => const [
              PopupMenuItem<String>(
                ...
                child: Text(AppStrings.pdfFile),
              ),
              PopupMenuItem<String>(
                value: AppStrings.email,
                height: 48,
                padding: EdgeInsets.symmetric(horizontal: 12),
                child: Text(AppStrings.sendEmail),
              ),
            ],
            onSelected: (value) {
              ...
              if (value == AppStrings.pdf) {
                ...
                if (state is ContactsLoaded) {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) =>
                          SendEmailScreen(contacts: state.contacts),
                    ),
                  );
                }
              }

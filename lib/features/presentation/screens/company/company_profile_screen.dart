...
import 'package:contact_app1/features/presentation/widgets/company/company_action_buttons.dart';
import 'package:contact_app1/features/presentation/widgets/company/company_info_field.dart';
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<CompanyCubit, CompanyState>(
          ...
          builder: (context, state) {
            ...
            return const Center(
              child: Text(AppStrings.seeTheInformation),
            );
          },
        ),
      ),

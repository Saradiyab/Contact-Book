  ...
  Future<void> login() async {
    ...
    if (email.isEmpty || password.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(AppStrings.emailPasswordEmpty),
...
class LoginForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        _buildTextField(emailController, AppStrings.email),
        const SizedBox(height: 15),
        _buildTextField(passwordController, AppStrings.password, obscureText: true),

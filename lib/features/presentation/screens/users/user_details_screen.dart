...
import 'package:contact_app1/features/presentation/business_logic/cubit/user_state.dart';
      ...
      listener: (context, state) {
        if (state is UserUpdated) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text(AppStrings.userUpdatedSuccess)),
          );
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: ListView(
            children: [
              Text(
                '${AppStrings.homeUser} ${widget.firstName} ${widget.lastName}',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          _buildInfoField(AppStrings.phone, _phoneController,
  ...
  Widget _buildHeader() {
    return Row(
      ...
      children: [
        ...
        Row(
          children: [
            const Text(AppStrings.editing, style: TextStyle(fontSize: 16)),
            Switch(
              value: isEditing,
  ...
  Widget _buildRoleDropdown() {
    ...
    return SizedBox(
      ...
      child: DropdownButtonFormField2<String>(
        ...
        hint: const Text(AppStrings.selectRole,
        ...
        validator: (v) =>
            (v == null || v.isEmpty) ? AppStrings.selectRole : null,
    ...
    return Column(
      children: [
        _buildButton(
          ...
          isEditing ? AppColors.blue : AppColors.blue,
          () {

...
import 'package:contact_app1/features/presentation/screens/users/create_user_screen.dart';
...
import 'package:contact_app1/features/presentation/widgets/users/user_build_button.dart';

import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

import '../../widgets/users/users_list_widget.dart';
...
class UsersScreenState extends State<UsersScreen> {
  ...
  Widget buildHeader() {
    return Column(
      ...
      children: [
        Text(AppStrings.homeUser, style: TextStyle(color: Colors.black, fontSize: 18)),
  ...
  Widget buildActionButtons() {
    return Row(
      children: [
        ...
        Expanded(
          child: UserBuildButton(
            text: AppStrings.inviteNewUsers,

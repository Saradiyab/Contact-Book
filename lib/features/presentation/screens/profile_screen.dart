      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _buildTextField(AppStrings.firstName, firstNameController,
                    keyboardType: TextInputType.name),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: _buildTextField(AppStrings.lastName, lastNameController,
                    keyboardType: TextInputType.name),
              ),
            ],
          ),
          ...
          const SizedBox(height: 20),
          _buildTextField(AppStrings.email, emailController,
              keyboardType: TextInputType.emailAddress),      
              const SizedBox(height: 20),
          _buildTextField(AppStrings.phone, phoneController,

        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _buildMenuItem(AppStrings.home.tr(), onTap: () {
                ...
                Divider(),
                _buildMenuItem(AppStrings.contacts.tr(), onTap: () {
                ...
                Divider(),
                _buildMenuItem(AppStrings.companyProfile.tr(), onTap: () {
                  if (ModalRoute.of(context)?.settings.name !=
                ...
                Divider(),
                _buildMenuItem(AppStrings.users.tr(), onTap: () {
                  if (ModalRoute.of(context)?.settings.name !=
                      "/users_screen") {
                    Navigator.pop(context);
                ...
                Divider(),
                _buildMenuItem(AppStrings.userName.tr(), onTap: () {
                  Navigator.pop(context);
                }),
                Divider(),
                _buildMenuItem(AppStrings.myProfile.tr(), icon: Icons.person, onTap: () {
                  if (ModalRoute.of(context)?.settings.name !=
                      "/profile_screen") {
                    Navigator.pop(context);
                ...
                _buildMenuItem(AppStrings.logOut.tr(), icon: Icons.logout, onTap: () {
                  Navigator.pop(context);
  ...
  Widget _buildMenuItem(String title, {IconData? icon, VoidCallback? onTap}) {
    return ListTile(
      ...
      title: Text(
        ...
        style: TextStyle(
          fontSize: 18,
          fontWeight: (title == AppStrings.myProfile.tr() || title == AppStrings.logOut.tr())
              ? FontWeight.normal
              : FontWeight.bold,
        ),
      ),
